...
public:
   sack();
  float sum(int,int,int[10],int[10],float[10]);
  void decreasep();
  void increasew();
  void decreasepw();
  void getd();
...
void sack :: getd()
    ...
    float sack::sum(int n,int cap,int wx[10],int px[10],float xx[10])
      {
      	int i;
       int cap1;
       cap1=capf;
  ...
  sack ::sack()
  {
	  ...
	  else if(profit1==profit3 && profit3==profit2)
	  {
